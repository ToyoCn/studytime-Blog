...
去 Charles 的官方网站（[http://www.charlesproxy.com](http://www.charlesproxy.com/)）下载最新版的 Charles 安装包，是一个 dmg 后缀的文件。打开后将 Charles 拖到 Application 目录下即完成安装。
...
![](https://static.studytime.xin/image/articles/charles/charles-pro-3.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-pro-4.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-filter-setting.jpg)

通常情况下，我们使用方法一做一些临时性的封包过滤，使用方法二做一些经常性的封包过滤。

方法三：在想过滤的网络请求上右击，选择 “Focus”，之后在 Filter 一栏勾选上 Focussed 一项，如下图所示：

![](https://static.studytime.xin/image/articles/charles/charles-focus.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-proxy-setting.jpg)

#### iPhone 上的设置

首先我们需要获取 Charles 运行所在电脑的 IP 地址，Charles 的顶部菜单的 “Help”->”Local IP Address”，即可在弹出的对话框中看到 IP 地址，如下图所示：

![](https://static.studytime.xin/image/articles/charles/charles-local-ip.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-iphone-setting.jpg)

设置好之后，我们打开 iPhone 上的任意需要网络通讯的程序，就可以看到 Charles 弹出 iPhone 请求连接的确认菜单（如下图所示），点击 “Allow” 即可完成设置。

![](https://static.studytime.xin/image/articles/charles/charles-proxy-confirm.jpg)
...
![](https://static.studytime.xin/image/articles/charles/charles-pro-1.png)

需要注意的是，即使是安装完证书之后，Charles 默认也并不截取 Https 网络通讯的信息，如果你想对截取某个网站上的所有 Https 网络请求，可以在该请求上右击，选择 SSL proxy，如下图所示：

![](https://static.studytime.xin/image/articles/charles/charles-ssl-add-host.jpg)
...
![](https://static.studytime.xin/image/articles/charles/charles-pro-2.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-throttle-setting.jpg)
...
![](https://static.studytime.xin/image/articles/charles/charles-edit.png)

我们可以修改该请求的任何信息，包括 URL 地址、端口、参数等，之后点击 “Execute” 即可发送该修改后的网络请求（如下图所示）。Charles 支持我们多次修改和发送该请求，这对于我们和服务器端调试接口非常方便，如下图所示：

![](https://static.studytime.xin/image/articles/charles/charles-execute.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-repeat-1.png)

接着我们就可以在弹出的对话框中，选择打压的并发线程数以及打压次数，确定之后，即可开始打压。

![](https://static.studytime.xin/image/articles/charles/charles-repeat-2.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-map.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-map-remote.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-save-response.png)

下图是一个示例，我将一个指定的网络请求通过 Map Local 功能映射到了本地的一个经过修改的文件中。

![](https://static.studytime.xin/image/articles/charles/charles-map-local.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-rewrite-1.jpeg)

我们想试着直接修改网络返回值，将 tangqiaoboy 换成成 iosboy。于是我们启用 Rewrite 功能，然后设置如下的规则：

![](https://static.studytime.xin/image/articles/charles/charles-rewrite-2.png)

完成设置之后，我们就可以从 Charles 中看到，之后的 API 获得的昵称被自动 Rewrite 成了 iosboy，如下图所示：

![](https://static.studytime.xin/image/articles/charles/charles-rewrite-3.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-breakpoint.png)
...
![](https://static.studytime.xin/image/articles/charles/charles-reverse-proxy.jpg)
...
## 文章来源:
本文转载自唐巧,原文链接为[http://blog.devtang.com/2015/11/14/charles-introduction/](http://blog.devtang.com/2015/11/14/charles-introduction/)
